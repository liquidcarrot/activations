export const Activation = {
     ...
     */
    Identitiy: (x: number, derivative: boolean = false): number => !derivative ? x : 1,
     ...
     * @param derivative calculate the derivative
     */
    BinaryStep: (x: number, derivative: boolean = false): number => {
        if (!derivative) {
            return x < 0 ? 0 : 1;
        } else {
            return 0;
     ...
     * @param derivative calculate the derivative
     */
    Logistic: (x: number, derivative: boolean = false): number => {
     ...
     * @param derivative calculate the derivative
     */
    TANH: (x: number, derivative: boolean = false): number => {
        if (!derivative) {
            return Math.tanh(x);
        } else {
     ...
     * @param derivative calculate the derivative
     */
    SQNL: (x: number, derivative: boolean = false): number => {
        if (!derivative) {
            if (x > 2) {
                return 1;
            } else if (x >= 0) {
     ...
     * @param derivative calculate the derivative
     */
    ArcTan: (x: number, derivative: boolean = false): number => {
        if (!derivative) {
            return Math.atan(x);
        } else {
            return 1 / (x ** 2 + 1);
     ...
     * @param derivative calculate the derivative
     */
    ArSinH: (x: number, derivative: boolean = false): number => {
        if (!derivative) {
            return Math.asinh(x);
        } else {
            return 1 / (x ** 2 + 1) ** (1 / 2);
     ...
     * @param derivative calculate the derivative
     */
    SoftSign: (x: number, derivative: boolean = false): number => {
        if (!derivative) {
     ...
     * @param derivative calculate the derivative
     */
    RELU: (x: number, derivative: boolean = false): number => {
        if (!derivative) {
            return x > 0 ? x : 0;
        } else {
            return x > 0 ? 1 : 0;
     ...
     * @param derivative calculate the derivative
     */
    LeakyRELU: (x: number, derivative: boolean = false): number => {
        if (!derivative) {
            return x > 0 ? x : 0.01 * x;
        } else {
            return x > 0 ? 1 : 0.01;
     ...
     * @param derivative calculate the derivative
     */
    SoftPlus: (x: number, derivative: boolean = false): number => {
        if (!derivative) {
     ...
     * @param derivative calculate the derivative
     */
    BentIdentity: (x: number, derivative: boolean = false): number => {
        if (!derivative) {
     ...
     * @param derivative calculate the derivative
     */
    SiLU: (x: number, derivative: boolean = false): number => {
        const negativeEX: number = Math.exp(-x);
        if (!derivative) {
     ...
     * @param derivative calculate the derivative
     */
    Sinusiod: (x: number, derivative: boolean = false): number => {
        if (!derivative) {
            return Math.sin(x);
        } else {
            return Math.cos(x);
     ...
     * @param derivative calculate the derivative
     */
    Sinc: (x: number, derivative: boolean = false): number => {
        if (!derivative) {
     ...
     * @param derivative calculate the derivative
     */
    GAUSSIAN: (x: number, derivative: boolean = false): number => {
        if (!derivative) {
